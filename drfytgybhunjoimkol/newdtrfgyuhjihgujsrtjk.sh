...
Install_RPM_Pack(){
	...
	if [ -z "${Centos8Check}" ]; then
		...
		centos67pack="db4-devel libpcap-devel vixie-cron"
	fi
	...
	yumPacks="libcurl-devel wget tar gcc make zip unzip openssl openssl-devel gcc libxml2 libxml2-devel libxslt* zlib zlib-devel libjpeg-devel libpng-devel libwebp libwebp-devel freetype freetype-devel lsof pcre pcre-devel crontabs icu libicu-devel c-ares libffi-devel bzip2-devel ncurses-devel sqlite-devel readline-devel tk-devel gdbm-devel xz-devel ${centos67pack}"
